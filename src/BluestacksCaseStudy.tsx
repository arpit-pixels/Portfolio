  ...
  return (
    ...
    <div className="cs">
      ...
      <header className="cs-hero" ref={heroR}>
        ...
        <p className="cs-sub">The product was already #1. The website hadn't kept up — so I redesigned the surfaces carrying nearly all the traffic.</p>
      ...
      <section className="cs-sec" ref={probR}>
        ...
        <div className="wsup-moats">
          <div className="wsup-moat"><div className="wsup-moat-n">01</div><div className="wsup-moat-name">Game-intent searchers</div><Reveal cue="who"><p className="wsup-moat-what">Searched "[game] on PC", landed on a game page. Wanted to play that one title fast — not read a spec sheet. The largest, most valuable traffic.</p></Reveal></div>
          <div className="wsup-moat"><div className="wsup-moat-n">02</div><div className="wsup-moat-name">Gamers without flagship phones</div><Reveal cue="who"><p className="wsup-moat-what">Came to the homepage to run AAA Android titles their device couldn't handle. The core homepage segment.</p></Reveal></div>
          <div className="wsup-moat"><div className="wsup-moat-n">03</div><div className="wsup-moat-name">Streamers & content creators</div><Reveal cue="who"><p className="wsup-moat-what">Wanted bigger screens, recording, multiple instances. The audience the feature/Powerups content actually spoke to.</p></Reveal></div>
          <div className="wsup-moat"><div className="wsup-moat-n">04</div><div className="wsup-moat-name">Power users & game farmers</div><Reveal cue="who"><p className="wsup-moat-what">Multi-instance, macros, key-mapping — the technical features that kept BlueStacks differentiated. They scroll for specs; everyone else doesn't.</p></Reveal></div>
        </div>
      </section>
      ...
      <section className="cs-sec" ref={mktR} style={{ paddingTop: 32, paddingBottom: 32 }}>
        ...
        <p className="cs-p" style={{ marginBottom: 20 }}>Rivals competed on performance and price. BlueStacks led on trust and reach — the redesign had to protect both.</p>
        ...
        <div className="wsup-also-tracked">
          <div className="wsup-also-card"><div className="wsup-also-body"><div className="wsup-also-name">NoxPlayer</div><Reveal cue="takeaway"><p className="wsup-also-takeaway">Lightweight emulator popular in Asia. Cleaner setup, but limited macro/multi-instance — missed the power-user segment.</p></Reveal></div></div>
          <div className="wsup-also-card"><div className="wsup-also-body"><div className="wsup-also-name">LDPlayer</div><Reveal cue="takeaway"><p className="wsup-also-takeaway">Aggressive marketing, near-identical feature set. Less polished onboarding; competed on price and benchmark numbers.</p></Reveal></div></div>
          <div className="wsup-also-card"><div className="wsup-also-body"><div className="wsup-also-name">MEmu</div><Reveal cue="takeaway"><p className="wsup-also-takeaway">Gaming-first, Asia-focused. Strong on older PCs, but weaker brand and trust signaling than BlueStacks.</p></Reveal></div></div>
          <div className="wsup-also-card"><div className="wsup-also-body"><div className="wsup-also-name">GameLoop (Tencent)</div><Reveal cue="takeaway"><p className="wsup-also-takeaway">Pushed hard for PUBG Mobile and CoD Mobile. Single-publisher orientation limited cross-game discovery.</p></Reveal></div></div>
        </div>
      </section>
      ...
      <section className="cs-sec" ref={resR}>
        ...
        <div className="cs-steps">
          ...
          /></p><p className="cs-step-rej"><span className="cs-rej-label">Rejected:</span> keeping the product screenshot. It sold the container, not the games inside it.</p></Reveal></div>
          <div className="cs-step"><div className="cs-step-n">02</div><h3 className="cs-step-h">Outcome copy over spec copy</h3><p className="cs-step-p">"Play Android games on PC" replaced "6× faster than a Galaxy S9+."</p><Reveal cue="the call"><p className="cs-step-p">Specs moved below the fold, where the power users who care actually look for them.<Pill
          ...
          /></p><p className="cs-step-rej"><span className="cs-rej-label">Rejected:</span> leading with benchmark numbers. Accurate, but it fell flat — and meant nothing to most visitors.</p></Reveal></div>
          <div className="cs-step"><div className="cs-step-n">03</div><h3 className="cs-step-h">A structured game-page template</h3><p className="cs-step-p">One template, thousands of search-ranked game pages.</p><Reveal cue="the call"><p className="cs-step-p">The highest-traffic surface. Rebuilt a wall of text into scannable blocks: rating + category up top, a single "Play on PC" CTA, then About, Tips, Features, a clean How-to, and system requirements. One template, thousands of game pages.</p><p className="cs-step-rej"><span className="cs-rej-label">Rejected:</span> a different layout per game. You can't hand-build thousands of search-ranked pages.</p></Reveal></div>
          <div className="cs-step"><div className="cs-step-n">04</div><h3 className="cs-step-h">Trust where doubt forms</h3><p className="cs-step-p">Intel · AMD · Samsung · Qualcomm — right where download anxiety peaks.</p><Reveal cue="the call"><p className="cs-step-p">Enterprise backer logos (Intel, AMD, Samsung, Qualcomm) placed on the homepage near the CTA. Emulator anxiety peaks right at the download decision.<Pill
          ...
          /></p><p className="cs-step-rej"><span className="cs-rej-label">Rejected:</span> a separate security page. Doubt forms in the first seconds, not three clicks deep.</p></Reveal></div>
        </div>
      </section>
      ...
      <section className="cs-sec cs-sec-dark" ref={screenR}>
        ...
        <p className="cs-p" style={{ color: "rgba(255,255,255,.55)" }}><strong style={{ color: 'rgba(255,255,255,.85)' }}>The old homepage opened on a screenshot of the app and a benchmark line.</strong></p>
        <Reveal cue="what changed" tone="dark">
          <p className="cs-p" style={{ color: "rgba(255,255,255,.55)" }}>The redesign opens on game characters and a single clear action, with the emulator's strengths reframed as feature cards below.</p>
        </Reveal>
        <BeforeAfterSlider
        ...
        <p className="cs-p" style={{ color: "rgba(255,255,255,.55)" }}><strong style={{ color: 'rgba(255,255,255,.85)' }}>This template was replicated across thousands of game pages and drove the majority of search traffic.</strong></p>
        <Reveal cue="what changed" tone="dark">
          <p className="cs-p" style={{ color: "rgba(255,255,255,.55)" }}>The old version buried a long description under dated "Powerups" and "How to Play and Stream" sections. The redesign leads with the game's identity — art, rating, category — and a single CTA, then structures the rest into scannable, search-friendly blocks.</p>
        </Reveal>
        <BeforeAfterSlider
        ...
        <p className="cs-p" style={{ color: "rgba(255,255,255,.55)" }}><strong style={{ color: 'rgba(255,255,255,.85)' }}>The power features were the real differentiators — but the pages explaining them read like manuals.</strong></p>
        <Reveal cue="what changed" tone="dark">
          <p className="cs-p" style={{ color: "rgba(255,255,255,.55)" }}>Multi-instance is the clearest example: the old page was a thin "what is it / how to set it up" explainer. The redesign turns it into a visual story — what you can actually do (run multiple games, multiple accounts, 64- and 32-bit side by side), why it matters, and how to start — so a first-timer understands the feature, not just its steps.</p>
        </Reveal>
        <BeforeAfterSlider
      ...
      <section className="cs-sec" ref={processR}>
        ...
        <div className="wsup-failure">
          ...
          <p className="cs-p"><strong>Lesson:</strong> visitors buy the outcome — playing the game — not the engine.</p>
          ...
          <p className="cs-p"><strong>Lesson:</strong> share the structure, never the content.</p>
          <Reveal cue="the full story">
      ...
      <section className="cs-sec" ref={resultR}>
        ...
        <div className="cs-reflection">
          ...
          <p className="cs-p"><strong>Sell the outcome, not the engine.</strong></p>
          <Reveal cue="unpacked">
            <p className="cs-p">The biggest lever wasn't visual polish — it was moving from "6× faster than a phone" to "play your games on PC." People buy the result, not the spec.</p>
          </Reveal>
          <p className="cs-p" style={{ marginTop: 14 }}><strong>A template is a product.</strong></p>
          <Reveal cue="unpacked">
            <p className="cs-p">The game page wasn't one screen; it was thousands of live, indexed pages. Designing that structure once, well, mattered more than perfecting any single layout.</p>
          </Reveal>
          <p className="cs-p" style={{ marginTop: 14 }}><strong>Modernize without starting over.</strong></p>
          <Reveal cue="unpacked">
          <p className="cs-p">What made it hard — millions of users, thousands of ranked pages — was also the point. The win was a modern experience that kept the trust and the traffic intact.<Pill
