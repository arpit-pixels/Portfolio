  ...
  return (
    ...
    <div className="cs">
      ...
      <section className="cs-sec" ref={resultR}>
        ...
        <p className="cs-p" style={{ marginBottom: 6 }}><strong>What my redesign moved</strong> — approximate figures from the site analytics around the launch.<Pill
          q="How were these measured — and are they clean numbers?"
          a="Before/after on the surfaces I redesigned: download click-through from the download-CTA funnel, average session duration, scroll-depth tracking, and homepage→onward navigation. They're approximate — five years of other changes make perfect isolation impossible, so I hold them as directional. But the movement was real and in the right direction."
        /></p>
        <div className="cs-result-grid">
          <div className="cs-result"><div className="cs-result-n">+18%</div><div className="cs-result-l">Click-through to download BlueStacks</div></div>
          <div className="cs-result"><div className="cs-result-n">+3–5 min</div><div className="cs-result-l">Longer average sessions</div></div>
          <div className="cs-result"><div className="cs-result-n">~50%</div><div className="cs-result-l">Of homepage visitors explored deeper instead of bouncing</div></div>
          <div className="cs-result"><div className="cs-result-n">+3–5%</div><div className="cs-result-l">More visitors scrolled the page all the way to the bottom</div></div>
        </div>
        ...
        <div className="cs-result-grid">
          ...
          <div className="cs-result"><div className="cs-result-n">3</div><div className="cs-result-l">Surface types redesigned — homepage, game pages, feature pages</div></div>
        </div>
        <div className="cs-reflection">
          ...
          <p className="cs-p" style={{ marginTop: 14 }}><strong>Modernize without starting over.</strong><Reveal mode="pop" cue="unpacked">What made it hard — millions of users, thousands of ranked pages — was also the point. The win was a modern experience that kept the trust and the traffic intact.<Pill
            ...
            a="Fair to push — and I do report what's mine, not the company's growth. The Impact stats above are the before/after on the surfaces I redesigned: download click-through up ~18%, longer sessions, ~50% of homepage visitors exploring deeper, more full-page scrolls. They're approximate — five years of other changes make clean isolation impossible, so I hold them as directional. The honest win is both: the site stopped contradicting the product, and the behavior moved the right way."
          /></Reveal></p>
        </div>
      </section>
