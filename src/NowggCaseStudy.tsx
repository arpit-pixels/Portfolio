    ...
    <div className="cs">
      ...
      <section className="cs-sec" ref={probR}>
        ...
        <div className="wsup-moats">
          <div className="wsup-moat"><div className="wsup-moat-n">01</div><div className="wsup-moat-name">Casual gamers on weak devices<Reveal mode="pop" cue="who">Chromebook students, older phones, low-spec laptops. Cloud let them play AAA mobile games their hardware couldn't run.</Reveal></div></div>
          <div className="wsup-moat"><div className="wsup-moat-n">02</div><div className="wsup-moat-name">"Try before install" gamers<Reveal mode="pop" cue="who">Wanted to sample a game before committing 1–2GB of phone storage. The fastest conversion segment to repeat visits.</Reveal></div></div>
          <div className="wsup-moat"><div className="wsup-moat-n">03</div><div className="wsup-moat-name">Game-intent searchers<Reveal mode="pop" cue="who">Found now.gg via a specific game's "play online" search. Cared about that one title — discovery had to extend interest beyond it.</Reveal></div></div>
          <div className="wsup-moat"><div className="wsup-moat-n">04</div><div className="wsup-moat-name">Publishers + game studios<Reveal mode="pop" cue="who">Used the platform as a zero-friction demo channel for their own titles. Drove curated placements and exclusive launches.</Reveal></div></div>
        </div>
      </section>
      ...
      <section className="cs-sec" ref={mktR} style={{ paddingTop: 32, paddingBottom: 32 }}>
        ...
        <p className="cs-p" style={{ marginBottom: 20 }}>Everyone else streamed AAA titles to gamers who knew what they wanted. now.gg streamed mobile games to people who didn't.<Reveal mode="pop" cue="the market">Most "cloud gaming" products of the era targeted PC and console games — AAA titles streamed from data centers. now.gg was different: cloud Android games, instantly playable in any browser, no install or login. Its real competitors were narrower than "cloud gaming" makes it sound.</Reveal></p>
        <div className="wsup-also-tracked">
          <div className="wsup-also-card">
            <div className="wsup-also-body">
              <div className="wsup-also-name">NVIDIA GeForce NOW<Reveal mode="pop" cue="takeaway">Cloud PC gaming for AAA titles via Steam/Epic libraries. Adjacent category — performance-led, assumed users brought their own game library.</Reveal></div>
            </div>
          </div>
          <div className="wsup-also-card">
            <div className="wsup-also-body">
              <div className="wsup-also-name">Xbox Cloud Gaming<Reveal mode="pop" cue="takeaway">Console games via cloud, gated behind Game Pass. AAA-focused, Microsoft ecosystem. Strong on premium content, weak on instant casual play.</Reveal></div>
            </div>
          </div>
          <div className="wsup-also-card">
            <div className="wsup-also-body">
              <div className="wsup-also-name">Stadia (Google)<Reveal mode="pop" cue="takeaway">High-profile cloud PC gaming launch; shut down January 2023. Failed on discovery and library breadth — exactly the problems we were designing around.<Pill
          ...
          <div className="wsup-also-card">
            <div className="wsup-also-body">
              <div className="wsup-also-name">BlueStacks X (sister product)<Reveal mode="pop" cue="takeaway">Cloud Android via desktop app + browser. Same parent company. Shared cloud infra and player UX — the products converged where the mental models overlapped.</Reveal></div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="cs-sec" ref={resR}>
        ...
        <p className="cs-p"><strong>Visitors arrive wanting one of three things: what's popular, a genre, or one exact game.</strong><Reveal mode="pop" cue="the approach">Some want what's popular right now. Some want to browse by genre. Some know the exact game. The home page has to serve all three without pushing anyone down the wrong path.<Pill
        ...
        <div className="cs-steps">
          <div className="cs-step"><div className="cs-step-n">01</div><h3 className="cs-step-h">Hot Games carousel</h3><p className="cs-step-p">Trending as avatar circles — tap and play in seconds.<Reveal mode="pop" cue="the call"><span className="rv2-p">Trending games as avatar circles at the top — visual, immediate, no reading required. Users who know what's popular tap and play in seconds.</span><span className="rv2-p"><strong>Rejected:</strong> a static "Editor's Picks" tile. It assumed users trusted us to choose — but new visitors don't yet. Real-time popularity earns the click.</span></Reveal></p></div>
          <div className="cs-step"><div className="cs-step-n">02</div><h3 className="cs-step-h">Curated sections</h3><p className="cs-step-p">Top · Popular · More — solves the "same 10 games" problem.<Reveal mode="pop" cue="the call"><span className="rv2-p">Top Games, Popular Games, More Games — each surfaces different titles. Solves the "same 10 games" problem.<Pill
          ...
          /></span><span className="rv2-p"><strong>Rejected:</strong> a single "all games" infinite scroll. Looked clean but flattened every title to equal weight — discovery collapsed to whatever loaded first.</span></Reveal></p></div>
          <div className="cs-step"><div className="cs-step-n">03</div><h3 className="cs-step-h">Category browsing</h3><p className="cs-step-p">Genre nav for the minority who arrive knowing what they want.<Reveal mode="pop" cue="the call"><span className="rv2-p">Explore by Categories at the bottom. Simulation, RPG, Action, Strategy — for users who know what genre they want.<Pill
          ...
          /></span><span className="rv2-p"><strong>Rejected:</strong> a left-rail category nav like a Steam-style store. Heavy on a homepage that needed to feel like an instant playground, not a catalog.</span></Reveal></p></div>
          <div className="cs-step"><div className="cs-step-n">04</div><h3 className="cs-step-h">Search</h3><p className="cs-step-p">Keyboard-first, for users who know the exact game.<Reveal mode="pop" cue="the call"><span className="rv2-p">Persistent search bar at the top. For users who know the exact game — instant, keyboard-first.</span><span className="rv2-p"><strong>Rejected:</strong> making search the hero (an early iteration). For most visitors, an empty search bar is a question they can't answer yet.</span></Reveal></p></div>
        </div>
      </section>
      ...
      <section className="cs-sec cs-sec-dark" ref={screenR}>
        ...
        <p className="cs-p" style={{ color: "rgba(255,255,255,.55)" }}><strong style={{ color: 'rgba(255,255,255,.85)' }}>Problem: 1,000 games scrolled in a flat grid is paralysis.</strong><Reveal mode="pop" cue="the design" tone="dark">Users either bounce or pick the first thing they see. The home page needed to give every kind of visitor a starting point — Hot Games avatars at top for trending, card grid for browsing, categories at the bottom for intent-driven navigation. The right sidebar runs a live wsup.ai character chat — engagement while you decide.</Reveal></p>
      ...
      <section className="cs-sec" ref={processR}>
        ...
        <div className="wsup-failure">
          ...
          <p className="cs-p"><strong>Lesson:</strong> most visitors want to be shown, not asked.<Reveal mode="pop" cue="the full story">First iteration put search front and center — like a Google for games. Looked clean, tested poorly. Users who didn't know what to play (the majority) stared at an empty search bar. Switched to browsing-first with trending games up top. Game starts went up — users saw what was popular before they had to decide.</Reveal></p>
          <h4 className="wsup-failure-title" style={{ marginTop: 18 }}>Overloaded game detail pages</h4>
          <p className="cs-p"><strong>Lesson:</strong> the fix wasn't redesign — it was deletion.<Reveal mode="pop" cue="the full story">Early game detail pages tried to do everything — sell the game, list system requirements, surface reviews, push related titles, run a chat panel. The "Play" CTA disappeared into the noise. The fix wasn't redesign — it was deletion. Stripped everything except game art + one pink CTA + light context. Conversion from detail page to play climbed once the page made one offer instead of seven.<Pill
      ...
      <section className="cs-sec" ref={resultR}>
        ...
        <div className="cs-reflection">
          ...
          <p className="cs-p" style={{ marginTop: 14 }}><strong>Discovery beats search for gaming platforms.</strong><Reveal mode="pop" cue="unpacked">Most visitors don't know what they want to play — they want to be shown. Lead with trending and curated cards. Search exists for the minority who arrived with a name in mind, not as the primary surface.</Reveal></p>
          <p className="cs-p" style={{ marginTop: 14 }}><strong>One offer per surface, always.</strong><Reveal mode="pop" cue="unpacked">The biggest conversion lift came from deleting features, not adding them — a single pink "Play" CTA on the detail page beat a layout that tried to sell, inform, and cross-sell at once. Cloud removes friction; UX needs to honor that by not adding new friction back in.</Reveal></p>
        </div>
      </section>
